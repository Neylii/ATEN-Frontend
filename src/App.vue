    ...
    <div class="content container-fluid" style="">
        ...
        >
          ...
          <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
              <img
                src="../src/assets/images/commodore-add-sm.png"
                class="img-fluid"
                alt="..."
              />
            ...
            <div class="carousel-item">
              <img
                src="../src/assets/images/sky-add.png"
                class="img-fluid"
                alt="..."
              />
              <div class="carousel-caption d-none d-md-block"></div>
      ...
      <div class="row">
        ...
        <div class="card" style="width: 15rem">
          <img
            src="../src/assets/images/commodore.png"
            class="card-img-top"
            alt="..."
          />
          <div class="card-body">
            <h5 class="card-title">Console retro</h5>
            <p class="card-text">
      ...
      <div class="row">
        <div class="card" style="width: 15rem">
          <img
            src="../src/assets/images/ESS-PS4-.jpg"
            class="card-img-top"
            alt="..."
          />
          <div class="card-body">
